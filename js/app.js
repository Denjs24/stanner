...
window.onload = function (){
    ...
    function documentActions(e){
        ...
        if (targetElement.closest(".menu__head")){
            let targetElementParent = targetElement.closest('.menu__navigation');
            let menu = targetElement.closest('.menu__head');
            let menuArr = menu.querySelector('.menu__arrow');
            menuArr.classList.toggle('_active');
            let targetElementList = targetElementParent.querySelector('.menu__list')
            menu.classList.toggle('_active');
            targetElementList.classList.toggle('_active');
        }
    }
}
...
//     if (!e.target.classList.closest('.menu-item')) {
